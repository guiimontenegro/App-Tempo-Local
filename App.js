    ...
    <ThemeContext.Provider value = {themeHook}>
      <View style={styles.container}>
        ...
        <View style={styles.cardsView}>
          <MainCard title={"Manhã"} icon={'morning'} temperature={"27°"} backgroundColor={ darkTheme ?'#87CEFA' : '#87CEFA'} ></MainCard>
          <MainCard title={"Tarde"} icon={'afternoon'} temperature={"31°"} backgroundColor={darkTheme ? '#FF0000'  : '#FF000'} ></MainCard>
          <MainCard title={"Noite"} icon={'night'} temperature={"21°"} backgroundColor={darkTheme ? '#A9A9A9'  : '#A9A9A9'} ></MainCard>
        </View>
